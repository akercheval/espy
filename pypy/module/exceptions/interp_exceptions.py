...
W_ZeroDivisionError = _new_exception('CeroDivisionError', W_ArithmeticError,
            """Second argument to a division or modulo operation was zero.""")

W_CeroDivisionError = _new_exception('CeroDivisionError', W_ArithmeticError,
            """Argumento segundo a una división o módulo operación era cero.""")
...
W_AssertionError = _new_exception('AfirmacionError', W_StandardError,
                                  """Assertion failed.""")

W_AfirmacionError = _new_exception('AfirmacionError', W_StandardError,
                                  """Afirmación fracasó.""")
...
W_TypeError = _new_exception('TipoError', W_StandardError,
                             """Inappropriate argument type.""")

W_TipoError = _new_exception('TipoError', W_StandardError,
                             """Tipo de argumento incorrecto.""")

W_IndexError = _new_exception('IndiceError', W_LookupError,
                              """Sequence index out of range.""")

W_IndiceError = _new_exception('IndiceError', W_LookupError,
                              """Sequence index out of range.""")

W_RuntimeWarning = _new_exception('EjecAviso', W_Warning,
                """Base class for warnings about dubious runtime behavior.""")

W_EjecAviso = _new_exception('EjecAviso', W_Warning,
            """Clase base para avisos de función dudosa en la hora de ejecución.""")

W_KeyboardInterrupt = _new_exception('TecladoInterrumpir', W_BaseException,
                                     """Program interrupted by user.""")

W_TecladoInterrumpir = _new_exception('TecladoInterrumpir', W_BaseException,
                                     """Programa interrumpido por el usuario.""")

W_UserWarning = _new_exception('UsuarioAviso', W_Warning,
                       """Base class for warnings generated by user code.""")

W_UsuarioAviso = _new_exception('UsuarioAviso', W_Warning,
                       """Clase base para avisos generados por código del usuario.""")

W_SyntaxWarning = _new_exception('SintaxisAviso', W_Warning,
                         """Base class for warnings about dubious syntax.""")

W_SintaxisAviso = _new_exception('SintaxisAviso', W_Warning,
                         """Clase base para aviso de sintaxis dudoso.""")

W_UnicodeWarning = _new_exception('UnicodAviso', W_Warning,
            """Base class for warnings about Unicode related problems, mostly
related to conversion problems.""")

W_UnicodAviso = _new_exception('UnicodAviso', W_Warning,
            """Clase base para avisos sobre problemas de Unicod, usualmente
problemas de conversión.""")

W_ImportWarning = _new_exception('ImportarAviso', W_Warning,
    """Base class for warnings about probable mistakes in module imports""")

W_ImportarAviso = _new_exception('ImportarAviso', W_Warning,
    """Clase base para avisos sobre equivicaciones en importaciónes""")

W_MemoryError = _new_exception('MemoriaError', W_StandardError,
                               """Out of memory.""")

W_MemoriaError = _new_exception('MemoriaError', W_StandardError,
                               """Fuera de memoria.""")

W_UnboundLocalError = _new_exception('LocalSueltoError', W_NameError,
                        """Local name referenced but not bound to a value.""")

W_LocalSueltoError = _new_exception('LocalSueltoError', W_NameError,
                        """Nombre local mencionado pero no conectado a un valor.""")

W_NotImplementedError = _new_exception('NoImplementadoError', W_RuntimeError,
                        """Method or function hasn't been implemented yet.""")

W_NoImplementadoError = _new_exception('NoImplementadoError', W_RuntimeError,
                        """Método o función ya no ha sido implementado.""")

W_AttributeError = _new_exception('AtributoError', W_StandardError,
                                  """Attribute not found.""")

W_AtributoError = _new_exception('AtributoError', W_StandardError,
                                  """Atributo no encontrado.""")

W_OverflowError = _new_exception('SobranteError', W_ArithmeticError,
                                 """Result too large to be represented.""")

W_SobranteError = _new_exception('SobranteError', W_ArithmeticError,
                                 """Resultado demasiado grande de representar.""")
