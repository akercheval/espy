...
W_ComplexObject.typedef = TypeDef("complejo",
    __doc__ = """complejo(real[, imag]) -> número complejo

Crear un número complejo de un parte real y un parte opcional imaginario.
Es equivalente a (real + imag * 1j) donde el estándar para imag es 0.""",
    __nuevo__ = interp2app(W_ComplexObject.descr__new__),
    __new__ = interp2app(W_ComplexObject.descr__new__),
    __sacanuevosargs__ = interp2app(W_ComplexObject.descr___getnewargs__),
    ...
    __pal__ = interp2app(W_ComplexObject.descr_str),
    __str__ = interp2app(W_ComplexObject.descr_str),
    __hash__ = interp2app(W_ComplexObject.descr_hash),
    __forzar__ = interp2app(W_ComplexObject.descr_coerce),
    __coerce__ = interp2app(W_ComplexObject.descr_coerce),
    __formato__ = interp2app(W_ComplexObject.descr_format),
    __format__ = interp2app(W_ComplexObject.descr_format),
    __nocero__ = interp2app(W_ComplexObject.descr_nonzero),
    __nonzero__ = interp2app(W_ComplexObject.descr_nonzero),
    __ent__ = interp2app(W_ComplexObject.int),
    __int__ = interp2app(W_ComplexObject.int),
    __flot__ = interp2app(W_ComplexObject.descr_float),
